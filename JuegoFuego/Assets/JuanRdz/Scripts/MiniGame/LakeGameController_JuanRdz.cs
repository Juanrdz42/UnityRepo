...
public class LakeGameController_JuanRdz : MonoBehaviour
{
    public static LakeGameController_JuanRdz Instance;
    ...
    void ResetRunState()
    {
        ...
        if (QuestController_JuanRdz.Instance != null)
        {
            ...
            QuestController_JuanRdz.Instance.SetObjective("Toma 3 fotos acuáticas (0/3)");
        }
    }
    ...
    void EndGame()
    {
        ...
        if (QuestController_JuanRdz.Instance != null)
        {
            ...
            if (won)
            {
                ...
                quest.RegisterBiomeCompletion("acuatico");
    ...
    public void FinishGameAndGoToResults()
    {
        ...
        if (QuestController_JuanRdz.Instance != null)
        {
            ...
            if (QuestController_JuanRdz.Instance.currentPhotos >= QuestController_JuanRdz.Instance.targetPhotos)
            {
                ...
                QuestController_JuanRdz.Instance.RegisterBiomeCompletion("acuatico");
